...
export default function BookCard({ book }: BookCardProps) {
  ...
  return (
    <Link
      to={`/book/${book.id}`}
      className="group flex w-40 flex-col gap-2 rounded-md border border-stone-200 bg-white p-3 shadow-sm transition-transform hover:-translate-y-1 hover:shadow-md"
    >
      <div
